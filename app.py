...
def caixa_1_B():        
    ...
    print('CSV files caixa_1_B created successfully! hey')

    return 'CSV files caixa_1_B created successfully!'
...
def caixa_2_A():    
    ...
    print('CSV files caixa_2_A created successfully! hey')

    return 'CSV files caixa_2_A created successfully!'
...
def caixa_2_B():    
    ...
    print('CSV files caixa_2_B created successfully! hey')

    return 'CSV files caixa_2_B created successfully!'
...
def caixa_3_A():    
    ...
    print('CSV files caixa_3_A created successfully! hey')

    return 'CSV files caixa_3_A created successfully!'
...
def caixa_3_B():    
    ...
    print('CSV files caixa_3_B created successfully! hey')

    return 'CSV files caixa_3_B created successfully!'
